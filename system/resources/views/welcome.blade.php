...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section id="home-section" class="hero">
          ...
          <div class="slider-item" style="background-image: url('public/images/baground1.jpg');">
            ...
            <div class="container">
              <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-sm-12 ftco-animate text-center">
                  <h1 class="mb-2">100% Original &amp; Best Seller Produk</h1>
                  <h2 class="subheading mb-4">We deliver Lokal Shoes &amp; Footwear</h2>
                  <p><a href="#" class="btn btn-primary">View Details</a></p>
                </div>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">NOBERTOs</h2>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
