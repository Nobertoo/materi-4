...
@section('content')
    ...
    <div class="hero-wrap hero-bread" style="background-image: url({{asset('public/images/bagroundabout.jpg')}})">
      <div class="container">
...
<br><br><br>
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
      <div class="container">
        <div class="row">
          <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url({{asset('public/images/compas.jpg')}})">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Noberto</h2>
